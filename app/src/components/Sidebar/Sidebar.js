            ...
            <Nav className="me-auto" style={{display: 'none'}}>
              <ButtonGroup className="view-group">
                <Button
                  variant="light"
                  className={
                    "mode-edit-toolbar-item" +
                      (activeTap !== "presentation" ? " active" : "")
                  }
                  onClick={() => {
                    setActiveTap(null);
                  }}
                  title="Wechsel zum Bearbeiten-Modus"
                >
                  Bearbeiten
                </Button>
                <Button
                  variant="light"
                  className={
                    "mode-presentation-toolbar-item" +
                      (activeTap === "presentation" ? " active" : "")
                  }
                  onClick={() => {
                    setActiveTap('presentation');
                    setInfoModalShow(false);
                  }}
                  title="Wechsel zum Präsentieren-Modus"
                >
                  Präsentieren
                </Button>
              </ButtonGroup>
